def get_question(dim):
    ...
    "Policy Change": "Can update privacy policy without informing me?",
    ...
    "Deletion": "Accounts/Account data are permanent?",
    ...
    "1P Analysis": "Performs demographic analysis on data collected about me?",
